...
| STT | faster-whisper large-v3 / distil-large-v3 | pending M8 |
| TTS | Piper ONNX voices | pending M8 |
| Resume NER | spaCy pipeline | pending M4 |
| OCR fallback | PaddleOCR / Tesseract | pending M4 |
| Identity match | InsightFace ArcFace (+ consent gate) | pending M8 |
| Proctoring signals | MediaPipe Face Mesh | pending M8 |
